...
El usuario mueve el mouse, o presiona una tecla  

### ¿Cómo se procesan y transforman?  
El código calcula y transforma la posición del mouse o detecta la tecla que se presionó.  

### ¿Qué respuesta visual producen? (OUTPUT)  
Los círculos se agrandan/achican o …  

## Pensamiento computacional  
### Reglas que gobiernan el sistema (inputs, procesos, outputs)  
Las reglas que gobiernan el sistema son: las condicionales (if - else if - else)  
